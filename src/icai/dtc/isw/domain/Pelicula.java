...
/**
 * Clase usada para generar los objetos 'Película', que contienen su título, director y los servicios donde está disponible
 */
public class Pelicula implements Serializable,Contenido{
    ...
    public Pelicula(String titulo, String director, ArrayList<String> servicios, String portada) {
    ...
    //para test
    public Pelicula(String titulo, String director, ArrayList<String> servicios) {
        this.setTitulo(titulo);
        this.setDirector(director);
        this.setServicios(servicios);
        this.setPortada(new String());
